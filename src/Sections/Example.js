          ...
          <div className="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
            {callouts.map((callout) => (
              <div key={callout.name} className="group relative">
                ...
                <h3 className="text-3xl md:text-4xl text-white pl-1 pt-8 font-bold text-gray-900">
                  <a href={callout.href}>
                    <span className="absolute inset-0" />
                    {callout.name}
                  </a>
                </h3>
                <p className="text-xl md:text-xl lg:text-xl xl:text-2xl text-white pl-1 mt-6 text-gray-500">
                  {callout.description}
                </p>
              </div>
            ))}
