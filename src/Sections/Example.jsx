...
const ExampleBlock = block(function Example() {
  ...
  return (
    ...
    <div id="example" className="flex flex-col lg:flex-row bg-[#f5ebdc]">
      ...
      <h1 class="pb-5 text-3xl lg:text-5xl font-bold text-black">Our Past Work</h1>

      <div className="text-[#695B55] font-semibold text-3xl">
